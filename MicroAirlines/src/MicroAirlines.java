...
public class MicroAirlines {
	...
	public static void main(String[] args) {
		...
		Booking b1 = new Booking("Anders Andersson", flights.get(0), TicketClassesEnum.ECONOMY, 5000 , 0, false, null);
		Booking b2 = new Booking("Bertil Bo", flights.get(0), TicketClassesEnum.ECONOMY, 5000 , 0, false, null);
		Booking b3 = new Booking("Conrad Canin", flights.get(0), TicketClassesEnum.FIRSTCLASS, 20000 , 0, false, null);
		Booking b4 = new Booking("David Duke", flights.get(0), TicketClassesEnum.ECONOMY, 5000 , 0, false, null);
		Booking b5 = new Booking("Erik Eriksson", flights.get(0), TicketClassesEnum.ECONOMY, 5000 , 0, false, null);
		Booking b6 = new Booking("Filip Filipsson", flights.get(0), TicketClassesEnum.FIRSTCLASS, 20000 , 0, false, null);
		Booking b7 = new Booking("Gustaf Gustavsson", flights.get(0), TicketClassesEnum.ECONOMY, 5000 , 0, false, null);
		Booking b8 = new Booking("Helge Helgesson", flights.get(0), TicketClassesEnum.FIRSTCLASS, 20000 , 0, false, null);
